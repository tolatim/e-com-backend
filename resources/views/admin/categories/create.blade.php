...
<div class="w-full">
    ...
    <div class="w-full bg-white border border-slate-200 rounded-xl shadow-sm">
            ...
            <div class="px-6 sm:px-8 py-6 border-b border-slate-100">
                <h1 class="text-xl font-semibold text-slate-900">New category</h1>
                <p class="mt-1 text-sm text-slate-500">Add a new category to organize your products.</p>
            </div>

            <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" class="px-6 sm:px-8 py-6 space-y-6">
                @csrf
